package fr.infotechnodev.termologia.quiz.elements;
...
public class QuestionList {
    ...
    private static final String TAG_QUESTION_ANSWER4 = "answer4";
    private static final String TAG_QUESTION_ANSWER5 = "answer5";
    ...
    public static class Question implements Serializable {
        ...
        public Question(Resources res, XmlResourceParser parser) {
            ...
            answer4 = getStringValue(res, parser, TAG_QUESTION_ANSWER4);
            answer5 = getStringValue(res, parser, TAG_QUESTION_ANSWER5);
        ...
        public boolean isUsable() {
            return id != -1 && question != null && answer1 != null && answer2 != null && answer3
                    != null && answer4 != null && answer5 != null && submitter != null && answer
                    != -1;
        }
    ...
    public List<Question> getNext20Questions() {
        List<Question> questions = new ArrayList<>();
        for (int i = 0; i < 20 && i < getNextMarathon().size(); i++) {
            questions.add(getNextMarathon().get(i));
        }
        return questions;
    }

    public List<Question> getNext50Questions() {
        List<Question> questions = new ArrayList<>();
        for (int i = 0; i < 50 && i < getNextMarathon().size(); i++) {
            questions.add(getNextMarathon().get(i));
        }
        return questions;
    }
