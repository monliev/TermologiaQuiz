package fr.infotechnodev.termologia.quiz.activities.main;
...
import fr.infotechnodev.termologia.quiz.activities.MainActivity;
import fr.infotechnodev.termologia.quiz.activities.QuestionActivity;
import fr.infotechnodev.termologia.quiz.activities.gamerules.GameRulesPagerAdapter;
import fr.infotechnodev.termologia.quiz.activities.gamerules.marathon.QuestionMarathonActivity;
import fr.infotechnodev.termologia.quiz.activities.gamerules.onetry.QuestionOneTryActivity;
import fr.infotechnodev.termologia.quiz.activities.gamerules.splitscreen.QuestionSplitScreenActivity;
import fr.infotechnodev.termologia.quiz.activities.gamerules.tenquestions.Question10QuestionsActivity;
import fr.infotechnodev.termologia.quiz.activities.gamerules.fiveteenquestions
        .Question50QuestionsActivity;
...
import fr.infotechnodev.termologia.quiz.views.QuizImageButton;
...
public class MainFragment extends Fragment {
    ...
    private static String DIALOG_TAG = "fr.infotechnodev.termologia.termologia.activities.main.dialogtag";
    ...
    public void onStartClick(View v) {
        ...
        if (gameRules.getId() == R.id.quiz_gamerules_10questions_id) {
            ...
            i.putExtra(QuestionActivity.KEY_QUESTION_LIST, (ArrayList<Question>) QuestionList.getInstance(mActivity).getNext20Questions());
        } else if (gameRules.getId() == R.id.quiz_gamerules_50questions_id) {
            i = new Intent(mActivity, Question50QuestionsActivity.class);
            i.putExtra(QuestionActivity.KEY_QUESTION_LIST, (ArrayList<Question>) QuestionList
                    .getInstance(mActivity).getNext50Questions());
