package fr.infotechnodev.termologia.quiz.activities.gamerules.splitscreen;
...
import fr.infotechnodev.termologia.quiz.views.RotatingLinearLayout;
...
public class FinishSplitScreenActivity extends FinishActivity {
    ...
    public static final String KEY_QUESTION_POINTS_2 = "fr.infotechnodev.termologia.termologia.activities.FinishSplitScreenActivity.KeyQuestionPoints2";
    ...
    public void onRestartClick(View v) {
        ...
        i.putExtra(QuestionActivity.KEY_QUESTION_LIST, (ArrayList<Question>) QuestionList.getInstance(this).getNext20Questions());
