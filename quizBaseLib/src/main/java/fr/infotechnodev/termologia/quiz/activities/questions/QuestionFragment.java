package fr.infotechnodev.termologia.quiz.activities.questions;
...
import fr.infotechnodev.termologia.quiz.animations.ButtonNextIncomeRunnable;
import fr.infotechnodev.termologia.quiz.animations.ButtonsBackgroundRunnable;
import fr.infotechnodev.termologia.quiz.animations.ShowExplanationRunnable;
...
import fr.infotechnodev.termologia.quiz.utils.TypeFaceUtils.ColorFont;
import fr.infotechnodev.termologia.quiz.views.AnswerButton;
import fr.infotechnodev.termologia.quiz.views.ColoredProgressBar;
...
public class QuestionFragment extends Fragment implements OnClickListener {
    ...
    public static String KEY_QUESTION = "fr.infotechnodev.termologia.termologia.activities.questions.QuestionFragment.KeyQuestion";
    public static String KEY_PLAYER = "fr.infotechnodev.termologia.termologia.activities.questions.QuestionFragment.KeyPlayer";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mButtons.add((AnswerButton) v.findViewById(R.id.fragment_question_button_answer4));
        mButtons.add((AnswerButton) v.findViewById(R.id.fragment_question_button_answer5));
