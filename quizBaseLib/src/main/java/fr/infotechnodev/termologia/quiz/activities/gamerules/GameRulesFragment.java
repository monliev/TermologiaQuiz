package fr.infotechnodev.termologia.quiz.activities.gamerules;
...
import fr.infotechnodev.termologia.quiz.views.CardViewPagerIndicator;

public class GameRulesFragment extends Fragment {

    private static final String TAG = GameRulesFragment.class.getName();

    public static String KEY_GAMERULES = "fr.infotechnodev.termologia.termologia.activities.gamerules.GameRulesFragment.KeyGameRules";
    public static String KEY_INDEX = "fr.infotechnodev.termologia.termologia.activities.gamerules.GameRulesFragment.KeyIndex";
    public static String KEY_ELEMENTS = "fr.infotechnodev.termologia.termologia.activities.gamerules.GameRulesFragment.KeyElements";
        ...
        if (highscore >= 0) {
            ...
            if (mGameRules.getId() == R.id.quiz_gamerules_10questions_id) {
                textHighScore = getString(R.string.quiz_activity_main_highscore2, highscore,
                        (20 * Integer.valueOf(mGameRules.getValue1())));
            } else if (mGameRules.getId() == R.id.quiz_gamerules_50questions_id) {
                textHighScore = getString(R.string.quiz_activity_main_highscore2, highscore,
                        (50 * Integer.valueOf(mGameRules.getValue1())));
